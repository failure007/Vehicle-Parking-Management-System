...
//todays Vehicle Entries
 $query=mysqli_query($con,"select ID from tbbookedslots where date(check_in_time)=CURDATE();");
...
//Yesterdays Vehicle Entrie
 $query1=mysqli_query($con,"select ID from tbbookedslots where date(check_in_time)=CURDATE()-1;");
...
//Last Sevendays Vehicle Entries
 $query2=mysqli_query($con,"select ID from tbbookedslots where date(check_in_time)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
//Total Vehicle Entries
 $query3=mysqli_query($con,"select ID from tbbookedslots");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <a href="reg-users.php" class="btn btn-transperent btn-sm"><?php echo $regdusers;?></a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <a href="manage-category.php" class="btn btn-transperent btn-sm"><?php echo $listedcat;?></a>
                                            <!-- <div class="stat-text"><span class="count"><a href="manage-category.php"><?php echo $listedcat;?></a></span></div> -->
