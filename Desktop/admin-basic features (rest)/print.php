...
class ReceiptIterator implements Iterator
{
    private $position = 0;
    private $vehicleData = [];
    ...
    {
        $result = mysqli_query($con, "select * from tblvehicle where ID='$cid'");
        $this->vehicleData = mysqli_fetch_assoc($result);
    }
...
if (strlen($_SESSION['vpmsaid']) == 0) {
    ...
    $cid = $_GET['vid'];
    $receiptIterator = new ReceiptIterator($con, $cid);

    foreach ($receiptIterator as $row) {
        ?>
