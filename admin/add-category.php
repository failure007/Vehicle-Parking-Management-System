                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-3 mt-4"><label for="text-input" class=" form-control-label">Vehicle Cost ($/h)</label></div>
                                        <div class="col-12 col-md-9 mt-4"><input type="number" id="vehicle_cost" name="vehicle_cost" class="form-control" placeholder="Vehicle Cost" required="true"></div>
                                    </div>
