...
session_start();
error_reporting(0);
include(__DIR__ . '/../../users/includes/dbconnection.php');
...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblvehicle(user_name,ParkingNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber) value('$user_name','$parkingnumber','$catename','$vehcomp','$vehreno','$ownername','$ownercontno')");
    if ($query) {
